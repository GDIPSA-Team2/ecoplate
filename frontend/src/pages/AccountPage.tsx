...
export default function AccountPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div>
        <h1 className="hidden lg:block text-2xl lg:text-3xl font-bold text-foreground">Account Settings</h1>
        <p className="text-sm lg:text-base text-muted-foreground">Manage your profile and preferences</p>
      </div>
